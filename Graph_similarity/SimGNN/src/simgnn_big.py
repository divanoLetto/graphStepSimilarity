...
class SimGNN_Big(SimGNN):
    ...
    def setup_layers(self):
        ...
        self.attention = AttentionModule_Big(self.args)
        self.tensor_network = TenorNetworkModule_Big(self.args)
...
class AttentionModule_Big(AttentionModule):
...
class TenorNetworkModule_Big(TenorNetworkModule):
