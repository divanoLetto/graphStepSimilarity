...
def score_2_excel(excel_score_path, high_max, image_dir_path, scale_x=0.03, scale_y=0.03):
    ...
    df_dict = {name: df}
    write_dataFrame_by_images(df_dict=df_dict, file_name='parts_retrieval_match_.xlsx', names=part_names,
